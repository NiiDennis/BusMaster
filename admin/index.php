...
$logs_cnt = query("booking")->num_rows;
$users_cnt = query("registration")->num_rows ;
$riders_cnt = query("drivers")->num_rows ;

/* $logs = query("logs");


$pen_logs_cnt = query2("logs", " WHERE status = 'pending' ")->num_rows ;
 */
...
?>
    ...
    <script src="dist/js/getriders.js"></script>
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="alllogs.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3><?php echo $riders_cnt;?><sup style="font-size: 20px"></sup></h3>
                        ...
                        <a href="allRiders.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-md-4">
            ...
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Active Riders</h3>
                ...
                <div class="box-body no-padding">
                    ...
                    <ul class="users-list clearfix" id="acriders">
                ...
                <div class="box-footer text-center">
                    <a href="allRiders.php" class="uppercase">View All Riders</a>
                </div>
                <!-- /.box-footer -->
            </div>
           </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                <?php while ($rider = mysqli_fetch_assoc($logs)) { ?>
                    ...
                    <div class="box-footer clearfix">
                        <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">View All Orders</a>
