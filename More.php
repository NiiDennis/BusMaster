...
<head>
    ...
    <link rel="stylesheet" href="Nova driver details/css/bootstrap.min.css">
    <link rel="stylesheet" href="Nova driver details/css/bootstrap-responsive.min.css">
    <link rel="stylesheet" href="Nova driver details/css/font-awesome.min.css">
    <link rel="stylesheet" href="Nova driver details/css/main.css">
    <link rel="stylesheet" href="Nova driver details/css/sl-slide.css">
...
<section id="portfolio" class="container main">    
    <ul class="gallery col-4">
            <!--Item 1-->
            <li>
                <div class="preview"><img src="300 x 180/Q1.jpg">
                  <div class="overlay">
                  </div>
                  <div class="links">
            ...
            <li>
              <div id="modal-1" class="modal hide fade">
                ...
                <div class="modal-body">
                  <img src="500 X 300/Q3.jpg" alt=" " width="100%" style="max-height:400px">
                </div>
              </div>                 
            </li>
            <!--/Item 1--> 
            ...
            <li>
                ...
                <div id="modal-1" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                      <img src="500 X 300/Q4.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 2-->
            ...
            <li>
                ...
                <div class="desc">
                  ...
                  <em>SCANIA</em> <br>
					<em>GR 523 09</em><br>
					<em>75 Seater</em ><br>
					<em>ACCRA-TAKORADI</em>
                </div>
                <div id="modal-3" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                      <img src="500 X 300/Q5.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 3--> 
            ...
            <li>
                ...
                <div id="modal-4" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                      <img src="500 X 300/Q6.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 4--> 
            ...
            <li>
                ...
                <div id="modal-6" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                      <img src="500 X 300/P4.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 6-->                 
            ...
            <li>
                ...
                <div id="modal-1" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src= alt= "500 X 300/Q23.jpg" width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 7-->
            ...
            <li>
                ...
                <div id="modal-8" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                      <img src="500 X 300/Q8.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 8-->
            ...
            <li>
                ...
                <div id="modal-9" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                      <img src="500 X 300/Q2.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 9--> 
            ...
            <li>
              <div class="preview"> <img alt=" " src="300 x 180/Q1.jpg">
                <div class="overlay"></div>
                <div class="links"> <a data-toggle="modal" href="#modal-12"><i class="icon-eye-open"></i></a><a href="#"><i class="icon-link"></i></a> </div>
              </div>
              <div class="desc">
                <h5>PRINCE TWUM</h5>
                <em>TOYOTA</em><br>
            ...
            <div class="row-fluid">
                ...
                <div class="span3">
                    ...
                    <div class="row-fluid first">
                        <ul class="thumbnails">
                          <li class="span3">
                            <a href="http://www.flickr.com/photos/76029035@N02/6829540293/" title="01 (254) by Victor1558, on Flickr"><img src="images/A1.jpg" width="271" height="186" alt="01 (254)"></a>
                        </li>
                        <li class="span3">
